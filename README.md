...
- [x] Backend: аутентификация, каталог, корзина, избранное, профиль, платежи Stripe
- [x] Frontend: базовая структура приложения и подключение зависимостей
- [ ] Frontend: экраны каталога, корзины, избранного, профиля и оплаты
